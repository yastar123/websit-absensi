      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          ...
          <div className="space-y-2 text-center">
            <p className="text-sm text-muted-foreground font-medium">Akun Demo (Password: demo123):</p>
            <div className="grid grid-cols-1 gap-2 text-sm">
              ...
              <button
                ...
                className="flex flex-col items-center p-2 rounded-lg border border-border hover:bg-accent transition-colors"
              >
                <span className="font-bold text-primary">Supervisor (Marketing)</span>
              ...
              <button
                ...
                className="flex flex-col items-center p-2 rounded-lg border border-border hover:bg-accent transition-colors"
              >
                <span className="font-bold text-primary">Staff (Marketing)</span>
                <span className="text-xs text-muted-foreground">staff@company.com</span>
              </button>
            </div>
          </div>
        </div>
